...
- FIX : Stabilisation DocEdit / Agefodd sur la chaîne UI -> runtime -> rendu, correction des substitutions manquantes, boucles exposées de façon cohérente avec l'UI et durcissement des modèles Agefodd liés *12/03/2026* - 2.21.9
