...
/**
 * \file       htdocs/core/modules/referenceletters/mod_referenceletters_advanced.php
...
class mod_referenceletterselements_advanced extends ModeleNumRefReferenceLettersElements
{
	...
	public function getNextValue($object)
	{
		...
		$numFinal = get_next_value($db, $mask, 'referenceletters_referenceletters', 'ref', '', null, $date);
