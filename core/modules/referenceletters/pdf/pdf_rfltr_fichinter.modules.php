...
/**
 * \file referenceletters/core/modules/referenceletters/pdf_rfltr_intervention.modules.php
 ...
 */
class pdf_rfltr_fichinter extends ModelePDFReferenceLetters
{
	public $db;
	public $name;
	public $description;
	...
	function __construct($db) {
		...
		$this->db = $db;
		$this->name = "referenceletter_fichinter";
	...
	public function write_file($object, $instance_letter, $outputlangs, $doctype='', $doctypedir='') {
		return parent::write_file($object, $instance_letter, $outputlangs, 'ficheinter', 'fichinter');
	}
