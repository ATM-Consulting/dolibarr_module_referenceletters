<?php
	...
	echo '</td>';
	echo '<td>';
	echo $referenceletters_tools->selectElementType($refltrelement_type, 'refltrelement_type',0,array('invoice','thirdparty','contact'));

	if($refltrelement_type) print $referenceletters_tools->selectReferenceletters($idletter, 'idletter', $refltrelement_type);
