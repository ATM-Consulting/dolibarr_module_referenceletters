...
/**
 * \file    test/phpunit/ReferencelettersFunctionalTest.php
...
/**
 * Class ReferencelettersFunctionalTest
 *
 ...
 *
 * @package Testreferenceletters
 */
class ReferencelettersFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modReferenceletters')->click();
		} else {
			// Disable the module
			$this->byHref('modReferenceletters')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/referenceletters/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('referenceletters/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/referenceletters/admin/about.php');
		$this->authenticate();
		return $this->assertContains('referenceletters/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('referenceletterswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modReferenceletters_ReferencelettersTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modReferenceletters_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
